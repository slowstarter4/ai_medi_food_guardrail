...
def generate_explanation(
    ...
    1. **근거 기반 설명**: 제공된 [의학적 근거데이터]의 '강도(Strength)'와 '출처(Source)'를 반드시 명시하여 경고의 신뢰도를 높이세요. (예: "FDA 약물 라벨의 높은 강도(HIGH) 경고에 따르면~")
    2. **원인-위험-행동 흐름**: 제공된 'evidence_summary_user'의 [원인 -> 위험 -> 행동] 논리 구조를 해치지 말고 답변에 온전히 녹여내세요.
    3. **정중하고 다정한 말투**: 김영순 여사님(어르신)도 이해하기 쉽도록 쉽고 친절한 말투를 유지하되, 위험성은 단호하게 전달하세요.
    4. **출처 명시**: 답변 하단의 [출처] 섹션에는 참고한 'evidence_source_label'을 모두 나열하세요.
