...
export function SettingsPage() {
  ...
  const faqItems = [
    ...
    {
      q: "RED와 YELLOW 등급은 어떻게 다르나요?",
      a: "RED는 즉시 섭취 중단 및 상담이 필수적인 긴급 위험 상태이며, YELLOW는 주의 섭취 및 전문가 상담을 권장하는 주의 상태입니다.",
    },
    {
      q: "경고 메시지를 받으면 반드시 상담해야 하나요?",
      a: "AI 분석은 보조적인 참고 자료입니다. 최종적인 의학적 결정은 반드시 의사 또는 약사와의 상담을 통해 진행하시기 바랍니다.",
    },
    {
      q: "데이터는 안전하게 보호되나요?",
      a: "모든 개인정보는 암호화되어 저장되며, 현재 버전은 브라우저 로컬 스토리지를 사용하여 사용자 기기에만 저장됩니다.",
    },
    {
      q: "OCR 인식 오류가 있을 경우 어떻게 수정하나요?",
      a: "결과 화면에서 성분명을 클릭하거나 하단의 수정 버튼을 통해 인식된 텍스트를 직접 편집할 수 있습니다.",
    },
    {
      q: "데이터 정보의 출처는 어디인가요?",
      a: "식약처(e약은요), FDA 등의 공용 데이터베이스와 최신 임상 가이드라인을 기반으로 검증된 정보를 제공합니다.",
    },
  ];
